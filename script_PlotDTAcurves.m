...
plot(tempsNew,DyTbScO3_1,'Color',[0.5 0 0.5]);  % DyTb
plot(tempsNew,DyTbScO3_2,'Color',[0.3 0.1 0.3]);  % DyTb
plot(tempsOld,DyScO3_1,'Color',[0 0 1]); % Dy
plot(tempsOld,DyScO3_2,'Color',[0 0.2 0.8]); % Dy
...
% figure2=figure('Position', [350 350 600 500]);
% subplot(2,1,1);
% hold on
% plot(tempsOld,GdScO3_1); % Gd
% plot(tempsOld,GdScO3_2); % Gd
% plot(tempsNew,TbGdScO3_1);  % TbGd
% plot(tempsNew,TbGdScO3_2);  % TbGd
% plot(tempsNew,DyTbScO3_1);  % DyTb
% plot(tempsNew,DyTbScO3_2);  % DyTb
% plot(tempsOld,DyScO3_1); % Dy
% plot(tempsOld,DyScO3_2); % Dy
% hold off
% subplot(2,1,2);
