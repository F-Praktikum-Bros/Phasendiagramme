...
Dabei fällt der Gitterparameter benachbarter $\text{REScO}_3$-Verbindungen mit steigender Ordnungszahl näherungsweise in 0.01 \AA-Schritten.
...
und $\text{Dy}_{0.5}\text{Tb}_{0.5}\text{ScO}_3$ untersucht.
