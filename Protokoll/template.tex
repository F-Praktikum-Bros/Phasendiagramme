...
Es ist naheliegend die Lage der Peakpositionen und die erwarteten Energieverschiebungen
...
Der unter dieser Voraussetzung von uns berechnete, optimale Wert ist $x=0.515$. Daraus folgt unter Verwendung der
Bandlücken von Indium und Gallium, jeweils gewichtet mit dem Faktor x, eine theoretische Bandlückenenergie
von $E_{g,InGaP} = 1.89\text{ eV}$ bei $T=300\text{ K}$.
