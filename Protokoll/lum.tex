...
Mit Hilfe der Arrheniusgleichung lassen sich die Peakintensitäten fitten und somit Rückschlüsse auf
die Aktivierungsenergie $E_a$ ziehen, die pro Teilchen aufgewendet werden muss, um eine Reaktion (strahlende Rekombination)
hervorzurufen:
...
\noindent In Abb. \ref{fig:intInt} ist dieser Fit dargestellt.
