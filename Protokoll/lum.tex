...
einem Doppelgaußfit unterzogen (Mathematica). Exzitonische Übergänge konnten nicht beobachtet werden. Dies lässt sich leicht
einsehen, wenn man die mittlere kinetische Energie eines Teilchens mit $k_B T=7\text{ meV}$ bei $T=80$ K nähert und
mit der exzitonischen Bindungsenergie (\ref{exitEbind}) vergleicht. Offensichtlich ist die Temperatur
...
direkte Beobachtung festgestellt werden.
...
\noindent Grund hierfür ist neben der thermischen Ausdehnung des Kristallgitters (Verringerung
...
herrühren. Die konkrete Abweichung der exp. Bandlücke von der theoretischen gibt Aufschluss über die Mengenverhältnisse von Ga und In in der Diode.
Die Materialzusammensetzung war vermutlich nicht genau an GaAs gitterangepasst, da die erhaltene
Bandlücke experimentell größer ausgefallen ist als theoretisch vorhergesagt (s. Abb. \ref{EgapT}). Neben Verunreinigungen des Materials könnte
die Ursache hierfür ein höherer Gehalt an Ga (GaP) sein (d.h $x>0.51$), da dies gemäß \ref{eq:Ex} zu einer größeren Bandlücke führt.
...
\noindent Diese trifft eine Aussage über die notwendige Energie eines Elektrons,
um über Phononen oder andere nicht-strahlende Prozesse zu relaxieren. In Abb. \ref{fig:intInt}
ist dieser Fit dargestellt. Wir erhalten eine Aktivierungsenergie von $E_A=33 \text{ meV}$. Diese liegt im erwarteten
Referenzbereich von $E_A=10-50\text{ meV}$ (für In$_{0,48}$Ga$_{0.52}$P) \cite{eact}.
...
sind vor allem Elektron-Phonon-Wechselwirkung für dieses Verhalten verantwortlich.
...
Es wurde das Lumineszenzspektrum einer InGaP/GaAs-Photodiode untersucht. Die charakteristische Temperaturabhängigkeit der
...
($x\approx 0.55$ wahrscheinlich). Die auf die Lumineszenz bezogene ermittelte Aktivierungsenergie von InGaP liegt im erwarteten Bereich.
Eine Fehlerquelle, die zu einer systematischen Abweichung der Bandlücke nach oben führen würde, ist die Reinheit des Kristalls. Bereits
geringste Verunreinigungen des Materials nehmen großen Einfluss auf die Phononen-Wechselwirkung, die v.a. an ebensolchen Defekten streuuen.
